...
extern void		display_init(struct screen *cur_screen, SDL_bool fullscreen, SDL_bool vsync);
...
extern SDL_bool		toggle_fullscreen(struct screen *cur_screen, SDL_bool fullscreen);
